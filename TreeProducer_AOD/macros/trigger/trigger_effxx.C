...
int trigger_effxx(){
  ...
  double QCD_xsec[NSAMPLES] = {1};

  string QCD_Samples[NSAMPLES] = {
  //"srm://maite.iihe.ac.be:8443//pnfs/iihe/cms/store/user/isdebruy/XXTo4J_M-1000_CTau-2000mm_TuneCUETP8M1_13TeV_pythia8/SIMPs_XXTo4J_ctau2000_M1000/170125_151140/0000/XXTo4J_",
  //"srm://maite.iihe.ac.be:8443//pnfs/iihe/cms/store/user/isdebruy/XXTo4J_M-50_CTau-100mm_TuneCUETP8M1_13TeV_pythia8/SIMPs_XXTo4J_ctau100_M50/170206_154235/0000/QCD_"
  //"srm://maite.iihe.ac.be:8443//pnfs/iihe/cms/store/user/isdebruy/XXTo4J_M-700_CTau-1000mm_TuneCUETP8M1_13TeV_pythia8/SIMPs_XXTo4J_ctau1000_M700_AOD/170225_202612/0000/XXTo4J_AOD_"
  "srm://maite.iihe.ac.be:8443//pnfs/iihe/cms/store/user/isdebruy/XXTo4J_M-700_CTau-100mm_TuneCUETP8M1_13TeV_pythia8/SIMPs_XXTo4J_ctau100_M700_AOD/170228_204456/0000/XXTo4J_AOD_"
...
for(int S=0; S<NSAMPLES; S++){
  ...
  tchain_corr[S] = new TChain("tree/SimpAnalysis");
   ...
   for (Long64_t i=0; i<nentries; i++) {
    ...
    if(i%100000 == 0) cout<<i<<" / "<<nentries<<"\r"<<flush;
      ...
      if( fabs(c_tree.jet_eta[0])<eta_cut && fabs(c_tree.jet_eta[1])<eta_cut && deltajet_phi>dphi_cut ){
        ...
        if(djet_chf0<0.1 and djet_chf1<0.1) h_pt_01_den->Fill(c_tree.jet_pt[1], c_tree.fChain->GetWeight());

        if(c_tree.HLT_DiCentralPFJet170_CFMax0p1 and djet_chf0<0.1 and djet_chf1<0.1) h_pt_01->Fill(c_tree.jet_pt[1], c_tree.fChain->GetWeight());
    ...
    c7->cd();
    h_chf_01->Draw();
    h_chf_01_den->SetLineColor(kRed);
    h_chf_01_den->Draw("same");


    TFile *fout = new TFile("Efficiency_XXTo4J_ctau100_M700.root", "RECREATE");
    fout->cd();
    h_chf_05_den->Write();
    h_chf_05->Write();
    h_chf_03_den->Write();
