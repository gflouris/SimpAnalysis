...
for j in {1..10}; do
  for i in {1..12}; do
    ...
    export id1=${j}
    export direc=$(pwd)
    cp SUS-RunIISummer16DR80Premix-00068_IIDD_cfg.py ./SUS-RunIISummer16DR80Premix-00068_IIDDD_cfg.py
    ...
    qsub -q localgrid -N simp10_step1_${i}\_${j} -o script_${i}\_${j}.stdout -e script_${i}\_${j}.stderr < simptmp.sh
    #rm ./simptmp.sh
