...
'file:///user/gflouris/Analysis/SIMPS/SignalProduction/P2PF_Ntuples/CMSSW_8_0_21/src/SimpAnalysis/P2PF/test/SUS-RunIISummer16DR80Premix-00068_NeutronGun_JECs.root'
)
)
...
process.jec = cms.ESSource('PoolDBESSource',
    CondDBSetup,
    connect = cms.string('sqlite:../data/Summer16_23Sep2016V4_MC.db'),
    toGet = cms.VPSet(
        cms.PSet(
...
process.tree.pfjetCollection  = cms.InputTag("AddPt:SubAddPFJets")
...
process.TFileService = cms.Service('TFileService',
    fileName = cms.string('SIMPs_PUMoriond17_AOD_NG_JECs.root')
)
